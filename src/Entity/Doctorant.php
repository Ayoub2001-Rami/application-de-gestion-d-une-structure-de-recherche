...
#[ORM\Entity(repositoryClass: DoctorantRepository::class)]
class Doctorant
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToOne(mappedBy: 'doctorant', targetEntity: SujetThese::class, cascade: ['persist', 'remove'])]
    private $sujetThese;
    ...
    public function setSujetThese(SujetThese $sujetThese): self
    {
        ...
        if ($sujetThese->getDoctorant() !== $this) {
            $sujetThese->setDoctorant($this);
        }
